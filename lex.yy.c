...
static yyconst flex_int16_t yy_base[21] =
    {   0,
        0,    0,   20,   21,    0,   21,    0,   21,   21,    5,
       21,    0,    0,    8,    0,    0,    7,   21,   15,   12
    } ;

static yyconst flex_int16_t yy_def[21] =
    {   0,
       18,    1,   18,   18,   19,   18,   19,   18,   18,   18,
       18,   20,   19,   18,   10,   20,   18,    0,   18,   18
    } ;

static yyconst flex_int16_t yy_nxt[35] =
    {   0,
        4,    5,    6,    7,    8,    9,    9,    9,    4,    9,
       10,   11,   12,   14,   16,   15,   13,   17,   17,   18,
